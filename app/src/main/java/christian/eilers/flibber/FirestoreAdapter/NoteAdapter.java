...
public class NoteAdapter extends FirestoreRecyclerAdapter<Note, NoteAdapter.NotesHolder> {

    HashMap<String, User> users;
    String groupID;
    StorageReference storage;

    public NoteAdapter(@NonNull FirestoreRecyclerOptions<Note> options, HashMap<String, User> users, String groupID) {
        super(options);
        this.users = users;
